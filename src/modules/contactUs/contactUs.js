...
const ContactUsPage = () => {
  ...
  return <div className={"contactUsPageContainer"}>
    ...
    <div>
    <HeadingDescription
      heading={<h1>{t("contact.reachUs.title")} <span style={{ color: "var(--primary-color)" }}>{t("contact.reachUs.highlight")}</span></h1>}
    />
        ...
        <Col xs={24} md={12}>
          <Space align="start">
            ...
            <div>
              ...
              <br/>
              <a href="mailto:contact@accelonhealth.com" target="_blank" rel="noopener noreferrer" title={t("contact.info.sendEmail")}>
      ...
      <div style={{ padding: "2rem", borderRadius: 8, background: "#fff" }}>
        <div style={{ display: "flex", gap: 6, justifyContent: "center" }}>
          ...
          <Title level={3} style={{ marginTop: 8, fontWeight: "bold" }}>
            {t("contact.offices.title")} <span style={{ color: "var(--primary-color)" }}>{t("contact.offices.highlight")}</span>
          </Title>
        </div>
        ...
        <Row gutter={[32, 32]} style={{ marginTop: 30 }}>
          <Col xs={24} md={12}>
            <Space align="start">
              ...
              <div>
                <Text className={"officeHead"}><Saudi style={{ height: 18, width: 18 }}/>{t("contact.offices.ksa.title")}</Text>
          ...
          <Col xs={24} md={12}>
            <Space align="start">
              <BankOutlined style={{ fontSize: 24 }}/>
              <div>
                <Text className={"officeHead"}><USA style={{ height: 18, width: 18 }}/>{t("contact.offices.usa.title")}</Text>
          ...
          <Col xs={24} md={12}>
            <Space align="start">
              <BankOutlined style={{ fontSize: 24 }}/>
              <div>
                <Text className={"officeHead"}><Egypt style={{ height: 18, width: 18 }}/>{t("contact.offices.egypt.title")}</Text>
                <Text>{t("contact.offices.egypt.addressLine1")}<br/>{t("contact.offices.egypt.addressLine2")}</Text>
              </div>
            </Space>
          </Col>
        </Row>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <ButtonComponent size={"large"} className={"scheduleBtn"}>{t("contact.ready.bookStrategy")}</ButtonComponent>
        </div>
      </div>
    </div>
    </div>
    ...
    <div className={"contentWrapper"}>
      <HeadingDescription
        heading={<h1>{t("contact.expect.title")} <span style={{ color: "var(--primary-color)" }}>{t("contact.expect.highlight")}</span></h1>}
      />
