      ...
      <div className="voiceContainer">
        ...
        <ContentImageBox>
          <div className="endToEndRcm" style={ { color: "var(--primary-text-color)" } }>
            ...
            <div className="fluent">
              <p><strong>{ t("voice.fluent.points.dialect.title") }</strong> → { t("voice.fluent.points.dialect.text") }
              </p>
              <p><strong>{ t("voice.fluent.points.script.title") }</strong> → { t("voice.fluent.points.script.text") }
              </p>
              <p><strong>{ t("voice.fluent.points.logging.title") }</strong> → { t("voice.fluent.points.logging.text") }
              </p>
              <p><strong>{ t("voice.fluent.points.routing.title") }</strong> → { t("voice.fluent.points.routing.text") }
              </p>
              <p><strong>{ t("voice.fluent.points.elastic.title") }</strong> → { t("voice.fluent.points.elastic.text") }
              </p>
            </div>
          </div>
        </ContentImageBox>
        ...
        <div style={ { backgroundColor: "rgba(28, 36, 96, .05 )" } }>
          <div className="contentWrapper">
            <div>
              <HeadingDescription
                heading={ <h1><span style={ { color: "var(--primary-color)" } }>{ t("voice.useCases.title") }</span>
                </h1> }
              />

              <CardComponent
                heading={ <h1><span
                  style={ { color: "var(--primary-color)" } }>{ t("voice.useCases.healthcare.title") }</span></h1> }
                description={
                  <ul className="voiceUl">
                    <li>
                      <strong>{ t("voice.useCases.healthcare.points.appointments.title") }</strong> { t("voice.useCases.healthcare.points.appointments.text") }
                    </li>
                    <li>
                      <strong>{ t("voice.useCases.healthcare.points.medication.title") }</strong> { t("voice.useCases.healthcare.points.medication.text") }
                    </li>
                    <li>
                      <strong>{ t("voice.useCases.healthcare.points.insurance.title") }</strong> { t("voice.useCases.healthcare.points.insurance.text") }
                    </li>
                    <li>
                      <strong>{ t("voice.useCases.healthcare.points.postVisit.title") }</strong> { t("voice.useCases.healthcare.points.postVisit.text") }
                    </li>
                  </ul>
                }
                image={ image2 }
            ...
            <CardComponent
              heading={ <h1><span
                style={ { color: "var(--primary-color)" } }>{ t("voice.useCases.service.title") }</span></h1> }
              description={
                <ul className="voiceUl">
                  <li>
                    <strong>{ t("voice.useCases.service.points.support.title") }</strong> { t("voice.useCases.service.points.support.text") }
                  </li>
                  <li>
                    <strong>{ t("voice.useCases.service.points.delivery.title") }</strong> { t("voice.useCases.service.points.delivery.text") }
                  </li>
                  <li>
                    <strong>{ t("voice.useCases.service.points.payment.title") }</strong> { t("voice.useCases.service.points.payment.text") }
                  </li>
                  <li>
                    <strong>{ t("voice.useCases.service.points.public.title") }</strong> { t("voice.useCases.service.points.public.text") }
                  </li>
                </ul>
              }
              image={ image1 }
