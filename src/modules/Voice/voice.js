...
const Voice = () => {
  return <div className={ "voiceContainer" }>
    <HeaderSection
      heading={ <h1>Your Clients Prefer to Talk. <span style={ { color: "var(--primary-color)" } }>Now Your Business Can Listen—24/7.</span></h1> }
    ...
    <ContentImageBox >
      <div className={ "endToEndRcm" } style={ {
        ...
        <h1>Fluent in <span style={ { color: "var(--primary-color)" } }>Business</span>, Fluent in <span style={ { color: "var(--primary-color)" } }>Culture</span>
        </h1>
        <p style={ {
          fontSize: "3rem",
          fontWeight: 500,
    ...
    <div className={"contentWrapper" }>
      <CardComponent
        ...
        description={ <div>
          ...
          <br/>
          <b>While others can sell automation, we deliver empathy at scale. AccelonVoice extends your team’s capacity without sacrificing the human touch.</b>
          <br/>
          <br/>
          <p style={ {
            color: "black",
            ...
            ✅ 2–4-week plug-and-play implementation  <br/> ✅ Omnichannel integration (EHR, CRM, WhatsApp, SMS)  <br/> ✅ ISO 27001 & HIPPAA compliance  <br/> ✅ 99.5% SLA uptime  <br/> ✅ 9× ROI in 3 months, 50% cost savings
          </p>
        </div> }
        image={ image4 }
        index={ 0 }
    ...
    <ContentBox>
      <div className={ "endToEndRcm" }>
        ...
        <p>
          When people feel heard, they choose you. AccelonVoice keeps lines open, calendars full, and teams calm—across healthcare and beyond.
        </p>
